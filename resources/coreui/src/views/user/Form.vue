                        ...
                        <div class="card-body">
                                ...
                                <div class="form-group col-sm-6">
                                    <b-form-fieldset label="First Name *">
                                        <b-form-input type="text" :class="errors.has('first_name') ? 'form-control is-invalid':'form-control'" v-validate="'required'"
                                            name="first_name" v-model="user.first_name" placeholder="Enter first name">
                                        </b-form-input>
                                    </b-form-fieldset>
                                </div>
                                <div class="form-group col-sm-6">
                                    <b-form-fieldset label="Last Name *">
                                        <b-form-input type="text" :class="errors.has('last_name') ? 'form-control is-invalid':'form-control'" v-validate="'required'"
                                            name="last_name" v-model="user.last_name" placeholder="Enter last name">
                                        </b-form-input>
                                    </b-form-fieldset>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    <b-form-fieldset label="Email *">
                                        <b-form-input type="text" :class="errors.has('email') ? 'form-control is-invalid':'form-control'" v-validate="'required'"
                                            name="email" v-model="user.email" placeholder="Enter Email Address">
                                        </b-form-input>
                                    </b-form-fieldset>
                                </div>
                                <div class="form-group col-sm-6">
                                    <b-form-fieldset label="Phone Number">
                                        <b-form-input type="text" v-model="user.phone_number" placeholder="Enter Phone Number">
                                    </b-form-input>
                                    </b-form-fieldset>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    ...
                                    <select class="form-control" :class="errors.has('company_id') ? 'form-control is-invalid':'form-control'" v-validate="'required'"
                                        name="company_id" v-model="user.company_id">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <select class="form-control" :class="errors.has('contact_type') ? 'form-control is-invalid':'form-control'" v-validate="'required'"
                                        name="contact_type" v-model="user.contact_type">
                                ...
                                <div class="form-group col-sm-6">
                                    <b-form-fieldset label="User Name *" v-if="user.is_user==true">
                                        <b-form-input type="text" :class="errors.has('username') ? 'form-control is-invalid':'form-control'" v-validate="'required'"
                                            name="username" v-model="user.username" placeholder="Enter user name">
                                        </b-form-input>
                                    </b-form-fieldset>
                                </div>
                                <div class="form-group col-sm-6">
                                    <b-form-fieldset label="Password *" v-if="user.is_user==true">
                                        <b-form-input type="text" :class="errors.has('password') ? 'form-control is-invalid':'form-control'" v-validate="'required'"
                                            name="password" v-model="user.password" placeholder="Enter Password">
                                        </b-form-input>
                                    </b-form-fieldset>
                                </div>
                            </div>
